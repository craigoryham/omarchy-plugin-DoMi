...
// Calendar panel with MTWTFSS day indicator and DoMi agenda.
// Based on omarchy.clock's Panel.qml — adds MTWTFSS strip above the hero
// and an agenda section below the month grid showing today's time blocks.
Panel {
  id: root
  moduleName: "user.domi-clock"
  ipcTarget: "user.domi-clock"
  manageIpc: false
  ...
  readonly property var allBlocks: (root.hostWidget && root.hostWidget.allBlocks) || []
  readonly property int eventCount: agendaBlocks.length
  ...
  function openDoMi() {
    if (typeof Quickshell !== "undefined")
      Quickshell.execDetached(["domi-launch"])
  }
    ...
    PanelKeyCatcher {
      ...
      Flickable {
        ...
        Column {
                ...
                Row {
                  ...
                  Repeater {
                    ...
                    Rectangle {
                      ...
                      // Event indicator dot
                      Rectangle {
                        visible: DoMi.countDay(root.allBlocks, modelData.key) > 0
                        width: Style.space(4)
                        height: Style.space(4)
                        radius: Style.space(2)
                        color: Color.accent
                        opacity: modelData.inMonth ? 1 : 0.55
                        anchors.horizontalCenter: parent.horizontalCenter
          ...
          Item {
            width: parent.width
            height: agendaColumn.visible ? agendaColumn.implicitHeight + Style.space(16) : 0
            visible: true
            ...
            Column {
              ...
              Text {
                textFormat: Text.PlainText
                text: root.eventCount > 0
                  ? "TODAY'S AGENDA  (" + root.eventCount + ")"
                  : "TODAY'S AGENDA"
                color: Qt.darker(root.contentForeground, 1.4)
                font.family: root.contentFontFamily
                font.pixelSize: Style.font.bodySmall
              ...
              // Agenda rows
              Repeater {
                model: root.eventCount > 0 ? root.agendaBlocks : []
                ...
                Row {
                  ...
                  Rectangle {
                    width: Style.space(4)
                    height: agendaTime.implicitHeight
                    radius: Style.space(2)
                    color: modelData.color || Color.accent
                    anchors.verticalCenter: agendaTime.verticalCenter
                  }
                  ...
                  Text {
                    id: agendaTime
                    textFormat: Text.PlainText
                    text: DoMi.formatRange(modelData)
                  ...
                  Text {
                    ...
                    font.family: root.contentFontFamily
                    font.pixelSize: Style.font.caption
                    font.bold: modelData.meeting === true
                    anchors.verticalCenter: parent.verticalCenter
                    width: agendaColumn.agendaRowWidth - Style.space(100)
                    elide: Text.ElideRight
                  }

                  // Meeting icon
                  Text {
                    visible: modelData.meeting === true
                    text: "󰒉"
                    color: Qt.darker(root.contentForeground, 1.5)
                    font.family: root.contentFontFamily
                    font.pixelSize: Style.font.caption
              ...
              // Helper property for text elide width
              property real agendaRowWidth: gridColumn.width - Style.space(100) - Style.space(10)
            }
          }
        }
      }
